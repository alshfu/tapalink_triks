<!-- 
для заболнения всей странички используйте значение:
div.main.theme-main
для заболнения блочной части используйте значение:
div.section-main
-->
...
# для анимации ripple
<script src="https://cdn.jsdelivr.net/npm/vanta@0.5.21/dist/vanta.ripple.min.js"></script>
# для анимации topology
